defmodule Extorrent.Peer.Control do
  @moduledoc false
  use GenServer
  ...
  alias Extorrent.Peer.Pool, as: PeerPool
  alias Extorrent.Peer.Worker, as: PeerWorker
  ...
  def handle_continue(:init, %{control_pid: control_pid, manager_pid: man_pid} = state) do
    ...
    pool_pid =
      case Extorrent.Peer.Manager.start_peer_pool(man_pid) do
