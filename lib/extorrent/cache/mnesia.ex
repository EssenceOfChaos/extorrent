defmodule Extorrent.Cache.Mnesia do
  @moduledoc false
  @behaviour Extorrent.Cache
  use GenServer
  require Logger

  @cache_prefix :extorrent_mnesia_cache

  # -------------------------------------------------------------------------------
  # GenServer Callbacks
  # -------------------------------------------------------------------------------
  def start_link(name, opts) do
    Logger.info("Starting Extorrent Mnesia Cache for #{inspect(name)} with #{inspect(opts)}")
